	...
	protected class InternalListView extends ListView implements EmptyViewMethodAccessor {
		...
		protected void dispatchDraw(Canvas canvas) {
			...
			try {
                ...
                Map<String, Object> pulltorrefreshMap = new HashMap<String, Object>();
                if(this.getAdapter()!=null) {
                    if(this.getAdapter().getCount()>2&&this.getAdapter().getItem(1)!=null){
                        Object item = this.getAdapter().getItem(1);
                        pulltorrefreshMap.put("StackOverflowError",item.getClass().getName());
                    }else{
                        pulltorrefreshMap.put("StackOverflowError",this.getAdapter().getClass().getName());
                    }
                }
