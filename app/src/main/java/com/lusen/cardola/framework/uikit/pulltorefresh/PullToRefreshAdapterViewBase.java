...
import com.lusen.cardola.framework.uikit.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	 ...
	 * {@link fm.xiami.bmamba.widget.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START}. The default value is <var>true</var> if
	 * {@link fm.xiami.bmamba.widget.pulltorefresh.PullToRefreshBase#isPullToRefreshOverScrollEnabled()
...
//		}
		...
		if (mAutoLoad){
			autoLoadScrollListener.onScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
		}
	...
	public final void onScrollStateChanged(final AbsListView view, final int state) {
		...
		if (mAutoLoad){
			autoLoadScrollListener.onScrollStateChanged(view,state);
		}
	...
	/**
	 * Pass-through method for {@link fm.xiami.bmamba.widget.pulltorefresh.PullToRefreshBase#getRefreshableView()
	 * getRefreshableView()}.
	 ...
	 * a state where a Pull-to-Refresh can happen. An example of this state is
	 * when the Adapter View is scrolled to the top and the mode is set to
	 * {@link fm.xiami.bmamba.widget.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START}
	 *
...
//			}
	...
	public void setAutoLoad(boolean autoLoad){
		...
		if (autoLoadScrollListener == null){
			autoLoadScrollListener = new AutoLoadScrollListener(this);
		}
	}


	public void setAutoLoad(boolean autoLoad, int autoLoadLeftCount){
		this.mAutoLoad = autoLoad;
		if (autoLoadScrollListener == null){
			autoLoadScrollListener = new AutoLoadScrollListener(this);
		}
		autoLoadScrollListener.setLeftCount(autoLoadLeftCount);
	}

	public void setAutoLoadEnable(boolean enable){
		if (autoLoadScrollListener != null){
			autoLoadScrollListener.setEnable(enable);
		}
	}
